...
<script type="text/javascript">
    function query(thisObj) {
        $.post("./gm/gulid.php", { "n": "gonghui",serverId: $("#serverId").val() }, function (data) {
            alert(data);
            $("#Msg").html(data);
        });
    }
    function del(thisObj) {
        $.post("./gm/gulid.php", { "n": "del",serverId: $("#serverId").val() }, function (data) {
            alert(data);
            $("#Msg").html(data);
        });
    }
        ...
        <div class="search-wrap">
            <div class="result-content">
                <table class="search-tab">
                    ...
                    <tr>
                        <td><span><input class="btn btn-primary btn2" id="sub1" value="工会查询" type="button" onclick="query()"></span>
                        </td>
                        <td><span><input class="btn btn-primary btn2" id="sub1" value="删除工会" type="button" onclick="del()"></span>
                        </td>
                    </tr>
                </table>
                <div class="Msg"></div>
