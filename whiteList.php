...
<script type="text/javascript" >
    function addwhite()
    {
        ...
        $.post("./gm/addwhite.php", {serverId:$("#serverId").val(),mac:$("#mac").val()},function(data)
            {
                $("#divMsg").html(data);
            }
        );
        ...
        <div class="search-wrap">
            <div class="search-content">
                <table class="search-tab">
                    ...
                    <tr>
                    <tr><td>IP:<input class="common-text" value="f681769ecc8557def59c1a4a7e4cc9bb" name="mac"  id="mac" type="text" ></td></tr>
                    <td><input class="btn btn-primary btn2" id="sub" value="执行" type="button" onclick="addwhite()"></td>
                    </tr>
                </table>
