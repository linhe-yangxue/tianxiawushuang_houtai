...
<script type="text/javascript" >
    function clearguildchat()
    {
        $.ajaxSetup({
            contentType: "application/x-www-form-urlencoded; charset=utf-8"
        });
        $.post("./gm/clearguildchat.php", {serverId:$("#serverId").val(),guild:$("#guild").val()},function(data)
            {
                $("#divMsg").html(data);
            }
        );
        ...
        <div class="search-wrap">
            <div class="search-content">
                <table class="search-tab">
                    ...
                    <tr>
                    <tr><td>宗门ID:<input class="common-text" value="1" name="guild"  id="guild" type="text" ></td></tr>
                        <td><input class="btn btn-primary btn2" id="sub" value="执行" type="button" onclick="clearguildchat()"></td>
                    </tr>
                </table>
