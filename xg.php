...
<script type="text/javascript" >
 function mail()
 {
  ...
  $.post("./gm/user.php", {PlatformUID:$("#PlatformUID").val(),gold:$("#gold").val(),diamond:$("#diamond").val(),lvl:$("#lvl").val(),vip:$("#vip").val(),vipScore:$("#vipScore").val(),honor:$("#honor").val(),ispk:$("#ispk").val(),prestige:$("#prestige").val(),genuineQi:$("#genuineQi").val(),rebirthLvl:$("#rebirthLvl").val(),rebirthExp:$("#rebirthExp").val(),tp:'edit'},function(data)
  {
   $("#Msg").html(data);
 }
 );
 ...
 function clear1()
 {
  ...
  $.post("./gm/user.php", {PlatformUID:$("#PlatformUID").val(),tp:'clear'},function(data)
  {
   $("#Msg").html(data);
 }
 );
